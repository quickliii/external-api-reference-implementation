...
const sampleScenario = {
  ...
  home_loans: [{ id: 'hl-1', existing_or_proposed: 'proposed', loan_type: 'owner_occupied', product_type: 'variable_package', loan_amount: 500000, term: 30, interest_only_period: 0, lvr: 71.43 }],
  liabilities: [],
